declare namespace UniApp {
    interface Uni {
        ...
        /**
         *
         * 创建插屏广告组件。请通过 [uni.getSystemInfoSync()](https://developers.weixin.qq.com/miniprogram/dev/api/base/system/system-info/wx.getSystemInfoSync.html) 返回对象的 SDKVersion 判断基础库版本号后再使用该 API。每次调用该方法创建插屏广告都会返回一个全新的实例（小程序端的插屏广告实例不允许跨页面使用）。
         *
         * 最低基础库： `2.6.0`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/wx.createInterstitialAd.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/wx.createInterstitialAd.html)
         */
    ...
    interface InterstitialAd {
         ...
         * 最低基础库： `2.8.0`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.destroy.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.destroy.html)
         */
        destroy(): void;
        /**
         *
         * 取消监听插屏广告关闭事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offClose.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offClose.html)
         */
         ...
         * 取消监听插屏错误事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offError.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offError.html)
         */
         ...
         * 取消监听插屏广告加载事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offLoad.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.offLoad.html)
         */
        offLoad(callback: OffLoadCallback): void;
        /**
         *
         * 监听插屏广告关闭事件。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onClose.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onClose.html)
         */
         ...
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onError.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onError.html)
         */
        onError(callback: InterstitialAdOnErrorCallback): void;
        /**
         *
         * 监听插屏广告加载事件。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onLoad.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.onLoad.html)
         */
         ...
         * 最低基础库： `2.8.0`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.load.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.load.html)
         */
        load(): Promise<any>;
        /**
         *
         ...
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.show.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.show.html)
         */
        show(): Promise<any>;
    }
